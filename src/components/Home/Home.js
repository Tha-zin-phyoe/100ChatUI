        ...
        <div className={classes.chat}>
                ...
                return (
                  <div
                    ...
                    <div className={classes.textContainer}>
                      ...
                      <div>
                        {oldmessage?.media ? (
                          <img src={oldmessage?.media} className={classes.image} alt=""></img>
                        ) : (
                          <>
                            {" "}
                            <div
                              ...
                              <div
                                ...
                                <svg
                                  ...
                                  id="turn-around-left-top-direction-circle-2"
                                  // data-name="Flat Line"
                                  ...
                                  <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path
                                      id="primary-2"
                                      data-name="primary"
                                      d="M8,10h5a3,3,0,0,1,3,3h0a3,3,0,0,1-3,3h0"
                                      style={{
                                        fill: "none",
                                        stroke: "#6e6e6e",
                                        strokeLinecap: "round",
          ...
          {replyMessage ? (
            <div className={classes.replyMessageContainer}>
              ...
              <span className={classes.replyClos} onClick={() => setReplyMessage(false)}>
                X
              </span>
            </div>
          ) : (
          ...
          <form className={classes.bottom} onSubmit={sendHandler}>
            <input
              ...
              placeholder={replyMessage ? "Reply Message" : "Type a Message"}
              value={messageData}
              onChange={(e) => {
